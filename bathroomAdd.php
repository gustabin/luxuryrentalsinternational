                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="control-group-inline" style="padding-top: 10px;">	
                            ...
                            Name <input name="bathroomName" type="text" class="span4 required" id="bathroomName"  maxlength="50" placeholder="Bathroom Name" style="width: 20%;" > &nbsp;
