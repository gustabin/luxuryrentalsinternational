...
span.red {
  ...
  width: 1.6em; 
    ...
    <!-- Start navigation -->
        ...
        <div class="navbar navbar-default navbar-transparent navbar-fixed-top" role="navigation"  data-20p="padding: 0px 0px; background: rgba(19, 43, 73, .95); border-color: rgba(19, 43, 73, 1);">
			<div class="container">
