                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="control-group-inline" style="padding-top: 10px;">	
                            ...
                            Name <input name="roomName" type="text" class="span4 required" id="roomName"  maxlength="50" placeholder="Room Name" style="width: 20%;" > &nbsp;
                            Description <input name="description" type="text" class="span4 required" id="description"  maxlength="50" placeholder="Description" style="width: 60%;" >
                        </div>
                    </div>
