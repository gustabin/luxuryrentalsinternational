 ...
 /* margin-right: 15px;*/
  ...
  width: 1.6em; 
	...
	<!-- Start navigation -->
		...
		<div class="navbar navbar-default navbar-transparent navbar-fixed-top" role="navigation" data-start="padding: 10px 0px; background: rgba(255, 255, 255, .1); border-color: rgba(255, 255, 255, .1);" data-20p="padding: 0px 0px; background: rgba(19, 43, 73, .95); border-color: rgba(19, 43, 73, 1);">
			<div class="container">
	...
	<!-- Light and dark logo -->
					<a href="index.php" class="navbar-brand">
						...
						<!--img class="img-responsive" src="img\logo.png" alt="" data-start="opacity: 0;" data-20p="opacity: 1;"!-->
                        <!--img class="img-responsive" src="img\logo.png" alt="" data-start="opacity: 0;" data-20p="opacity: 1;"!-->
                    </a>
				</div>
	...
	<!-- Navigation links -->    				
				<div class="collapse navbar-collapse" id="navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
                        <li><a href="#" data-start="color: rgb(255, 255, 255);" data-20p="color: rgb(0, 0, 0);"></a></li>
