...
<!-- Featured Villas -->	
  ...
  <?php
	...
	?>
<!-- .................................... $Contenido .................................... -->
<section id="doscolumnas">			
  <div class="container-fluid">
	<div class="row">		
		<div class="col-md-12">		
        <div id="sresults">		
                      <table id="sTable" class="tablesorter table table-hover">					  
...
if ($numero_filas <=10) {	?>						
                      <div class="row">
						...
						while($dataDetail=mysql_fetch_array($resultadoDetail))
							...
							?>
					<?php if ($x<=2) { ?>
                        <td align="justify" class="col-xs-18 col-sm-6 col-md-5">
						<div class="thumbnail">
                       ...
                       <!-- pager -->
                        <div id="pager" class="pager">
                           <form>
                            ...
                            <button type="button" class="btn btn-danger first" style="background-color: #ed8000;"><i class="fa fa-fast-backward" aria-hidden="true"></i></button>
                            <button type="button" class="btn btn-danger prev" style="background-color: #ed8000;"><i class="fa fa-backward" aria-hidden="true"></i></button>
