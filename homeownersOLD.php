							...
							<fieldset>
								 ...
								 <form data-toggle="validator" class="form-horizontal" role="form" id="formContacto"  enctype="multipart/form-data"  >
								   <font color="#000000">Who are you?</font><br>
									 ...
									 <textarea rows="5" placeholder ="Enter your properties features such as: Swiming Pool, Beachfront, Laundry, Spectacular view Security cameras, Golf Carts, Sports Courts, Marble Floors, Remodeled Kitchen, Entertainment System, etc. " cols="47"  name="anythingelse" id="anythingelse" style=" padding:6px; color:#000000"></textarea>   
									 <br><div style="height: 10px;"></div>
