<?php
	...
	if (empty($pathVilla)) {
		$pathVilla = "img/" .$country ."/" .$city ."/" . $villaName;		
		}
	...
	$howBig= $_POST['howBig'];	
	$marketingText= $_POST['marketingText'];	
	$url= $_POST['url'];
	//$season= $_POST['season'];
	...
	//===================== villa =============================
		...
		$query_villaDetail = "INSERT INTO villadetail (VillaId, Address, Address2, status, PathVilla, Country, RegionState, Province, 
			ZipCode, City, Phone, area, longitude, latitude, quantityroom, villadetailcol, quantitybath, contrystr, addressmapname, swimming) VALUES ('".$villaId."','".$address."', '".$address2."', '".$status."', '".$pathVilla."', '".$country."', '".$regionState."', '".$Province."', '".$zipCode."', '".$city."', '".$Phone."', '".$area."', '".$longitud."', '".$latitud."', '".$quantityroom."', '".$villadetailcol."', '".$quantitybath."', '".$countrystr."', '".$addressmapname."', '".$swimming."');";
