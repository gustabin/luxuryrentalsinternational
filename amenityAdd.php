                    ...
                    <div class="panel panel-default" align="center">
                        <div class="panel-heading">                        
                            ...
                            <div class="control-group-inline" style="padding-top: 10px;">	                                         			
                               Description: <input name="description" type="text" class="span4 required" id="description"  maxlength="70" placeholder="description" style="width: 40%;">
                               Category: <input name="category" type="text" class="span4 required" id="category"  maxlength="10" placeholder="category" style="width: 10%;">
                            </div>
                        </div>
