...
<script Language="JavaScript">
    ...
    function Modificar(id) {
		window.location.href='editVilla.php?id=' + id;
    }
      ...
      <ul class="breadcrumb">      
        <li><span id="titulo"></span></li>
        	<form  method="post" name="formBuscar" id="formBuscar">
        		<div class="controls">
          			<input type="text" id="nombre" name="nombre" style="width: 20%;"  placeholder="Villa name" />	  
    ...
    <div class="container">
    	    <div id="sresults" class="col-md-12">
   			<table id="sTable" class="tablesorter table table-bordered table-hover" style="border:1px solid #ECF0F1">
        		...
        		<tr style="background:#f5f5f5">
                    <td colspan="9" style="text-align: right">
                        <span class="span_required"id="ErrorBoton" style="display: none; font-size: 15px; float: left">
                            Choose the villa for edit or delete
                        </span>
                ...
                <tr>                    
                    <th width="50%" class="header" style="text-align: center">Villa</th>
					<th width="20%" class="header" style="text-align: center">Price from</th>
                    <th width="20%" class="header" style="text-align: center">Price to</th>
...
<?php
		...
		{	
			...
			$query = ("SELECT * FROM villa WHERE Name LIKE '%$name%'");
		}
		else
		{
      ...
      {
		$villaName = $data_his['Name'];
		$pricefrom = $data_his['pricefrom'];
