  ...
  <section class="section-breadcrumb section-color-graylighter" style="padding-top: 150px; padding-bottom: 10px;">
    <div class="container">
      ...
      <h2 class="section-title">
        Edit        
         <small>Room of <?php echo $_SESSION['villaName']; ?></small>              
      </h2>
      <a href='room.php?id=<?php echo $villaId ?>'>
       ...
       <a href='beds.php?id=<?php echo $Id ?>'>
            <button type="button" class="btn-main"><i class="fa fa-bed" aria-hidden="true"></i> Setting Beds </button>
       </a>     
      <!--ul class="breadcrumb">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="control-group-inline" style="padding-top: 10px;">	
                            ...
                            Name <input name="roomName" type="text" class="span4 required" id="roomName"  maxlength="50" placeholder="Room Name" style="width: 20%;" value="<?php echo $name ?>"> &nbsp;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">			
                    <a href = "room.php?id=<?php echo $villaId?>" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"> 
