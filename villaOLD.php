...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
				...
				?>
					<div class="item active" data-toggle="modal" data-target="#modal-gallery" align="center">							
							<div id="carousel-intro" class="carousel">
								<div class="carousel-inner text-center">
									<div class="active item">				
										<div class="caption">										
											<button type="submit" class="btn btn-default" style="margin-top: 650px;">View more photos</button>		
										</div>									
									</div>																		
								</div>
							</div>						
