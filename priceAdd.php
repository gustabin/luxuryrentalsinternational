...
include "header.php";
$villaId=$_GET["id"];
if (empty($villaId)) {header("Location: price.php");}
?> 
  ...
  <section class="section-breadcrumb section-color-graylighter" style="padding-top: 75px; padding-bottom: 10px;">
    <div class="container">
      ...
      <h2 class="section-title">
        Setting seasons
        <small>Price of <?php echo $_SESSION['villaName']; ?></small>   
      </h2>
  ...
  <section class="section-content section-contact section-color-graylighter" style="padding-top: 0px; background:#f5f5f5">
    <div class="container">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="control-group-inline" style="padding-top: 10px;">	
                                    ...
                                    Season <input name="season" type="text" class="span4 required" id="season"  maxlength="50" placeholder="Season" style="width: 50%;" value="<?php echo $name ?>"> &nbsp;
                                ...
                                <div class="control-group-inline" style="padding-top: 10px;">	
                                    Quantity Room <input name="quantityRoom" type="text" class="span4" id="quantityRoom"  maxlength="10" placeholder="Quantity Room" style="width: 15%;" value="Entire">
									Type <input name="type" type="text" class="span4" id="type"  maxlength="10" placeholder="Type" style="width: 15%;" value="Nightly">
									Price <input name="price" type="text" class="span4 required" id="price"  maxlength="13" placeholder="price" style="width: 15%;" value="$">
									minNights <input name="minNights" type="text" class="span4" id="minNights"  maxlength="10" placeholder="Minimun Nights" style="width: 15%;" value="3">
                                </div>
                            </div>
     ...
     <div class="alert alert-danger mensaje_form" style="display: none" id="error2">
		<button data-dismiss="alert" class="close" type="button">x</button>
		<strong>MESSAGE!</strong> <span class="textmensaje">This price exist already</span>
	 </div>
